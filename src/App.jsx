...
export default function App() {
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#fbfbfd] text-navy-800 antialiased font-sans pb-4">
      ...
      <div className="absolute top-[20%] right-[-15%] w-[700px] h-[700px] rounded-full bg-purple-200/15 bg-aurora-blob animate-blob-2 pointer-events-none" />
      <div className="absolute bottom-[30%] left-[-10%] w-[600px] h-[600px] rounded-full bg-emerald-100/10 bg-aurora-blob animate-blob-3 pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[0%] w-[700px] h-[700px] rounded-full bg-pink-100/15 bg-aurora-blob animate-blob-4 pointer-events-none" />
